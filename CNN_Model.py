...
# F1 loss - This function makes the threshold optimization unnecessary
...
# Uncomment this code and comment out the other line below to use the new loss func
#lenet_5_model.compile(loss=macro_double_soft_f1, optimizer=tf.keras.optimizers.Adam(learning_rate=0.001), metrics=[tf.keras.metrics.BinaryAccuracy(
